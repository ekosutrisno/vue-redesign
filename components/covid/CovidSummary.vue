  ...
  <div class="bg-cob-covid-gray rounded-lg shadow w-full p-4 h-auto">
    ...
    <div class="flex">
      <div class="w-1/4 p-2">
        ...
        <div class="text-sm md:text-lg xl:text-3xl text-orange-400 font-bold border-r-4 border-orange-300">{{dataSummary.total_cases}} <i class="fa fa-fw fa-user-injured"></i> </div>
      </div>
      <div class="w-1/4 p-2">
        <h1 class="text-xs sm:text-sm md:text-lg text-gray-600 mb-1">Aktif Kasus</h1>
        <div class="text-sm md:text-lg xl:text-3xl text-indigo-500 font-bold border-r-4 border-cob-covid-green">{{dataSummary.active_cases}} <i class="fa fa-fw fa-user-injured"></i> </div>
      </div>
      <div class="w-1/4 p-2">
        <h1 class="text-xs sm:text-sm md:text-lg text-gray-600 mb-1">Sembuh</h1>
        <div class="text-sm md:text-lg xl:text-3xl text-cob-covid-green font-bold border-r-4 border-red-500">{{dataSummary.recovered}} <i class="fa fa-fw fa-user-injured"></i> </div>
      </div>
      <div class="w-1/4 p-2">
        <h1 class="text-xs sm:text-sm md:text-lg text-gray-600 mb-1">Meninggal</h1>
        <div class="text-sm md:text-lg xl:text-3xl text-red-600 font-bold">{{dataSummary.deaths}} <i class="fa fa-fw fa-user-injured"></i> </div>
      </div>
    </div>
  </div>
</template>
